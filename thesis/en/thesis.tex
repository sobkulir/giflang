...
and advice, and also to my parents for their extensive support and patience. I would also like
to thank my motivation guru Peter Muroň.
}
...
The IDE features code-stepping with information about current location in the source
...
The purpose of the language is educational, e.g., to be used in creative games at programming camps for elementary
and high schoolers.
}
...
Účel tohto jazyka je edukatívny, môže byť napríklad použitý v hrách na programovacích sústredeniach pre žiakov
