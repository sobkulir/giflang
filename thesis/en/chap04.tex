...
the second line, but at the time of its creation \texttt{Z} does not exist. Therefore, it is natural to expect that invoking \texttt{G} fails.
However, it is not the case with mutable environments.
